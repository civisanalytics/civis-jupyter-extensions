# Contributing to civis-jupyter-extensions
...
1. Fork it ( https://github.com/civisanalytics/civis-jupyter-extensions/fork ).
2. Install it, with the development dependencies.  See `dev-requirements.txt`.
